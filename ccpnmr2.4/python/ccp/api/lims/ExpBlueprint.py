...
class ExpBlueprint(memops.api.Implementation.DataObject):
  r""")The information on the ExpBlueprint(that represents well defined)experimental objectives. The ExpBlueprint(groups wish targets or domain)of wish targets and non-polymer molecules.
  """
