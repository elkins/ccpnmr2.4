...
if (__name__ == '__main__'):
  ...
  print(s, type(s))  s = showOkCancel('title', 'ok2 message')
  print(s, type(s))  s = showYesNo('title', 'yes message')
  print(s, type(s))  s = showYesNo('title', 'yes2 message')
  print(s, type(s))  showWarning('title', 'warning message')
  ...
  print(messageReporter.showOkCancel('ok cancel title', 'ok cancel message'))  print(messageReporter.showYesNo('yes no title', 'yes no message'))